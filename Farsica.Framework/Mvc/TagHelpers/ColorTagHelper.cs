namespace Farsica.Framework.Mvc.TagHelpers
{
    ...
    public class ColorTagHelper(IHtmlGenerator generator, HtmlEncoder encoder, IOptions<MvcViewOptions> optionsAccessor) : UI.Bootstrap.TagHelpers.TagHelper(optionsAccessor)
    {
